...
class getIndexControllerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.2R6C62U'] ?? $container->load('get_ServiceLocator_2R6C62UService'))->withContext('App\\Engine\\Controller\\IndexController', $container));
