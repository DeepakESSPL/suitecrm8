...
class App_KernelProdContainer extends Container
{
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('60n49JBjEy', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Aj6e0u7U24', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('v1dr1NVlxG', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qWNmaOPcfb', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('cKyl1anZ-F', 0, $container->getParameter('container.build_id'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MgAyPEY1ah', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lV2cxtZDPC', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TmwpkYj+Rg', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XKuFtIaMuM', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['doctrine.result_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3FBhVB+W+g', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    {
        return $container->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Pt++WYqWxo', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getSerializerService($container)
    {
        ...
        $o = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($h, $i, $j, $a, $k, $l, $b, $f, $m, $container->parameters['api_platform.serializer.default_context'], $n, NULL);

        $p = new \ApiPlatform\JsonLd\Serializer\ErrorNormalizer($o, $container->parameters['api_platform.serializer.default_context']);
        $q = new \ApiPlatform\Serializer\ItemNormalizer($i, $j, $a, $k, $b, $f, $m, NULL, $h, $n, [], NULL);
        $r = ($container->services['translator'] ?? self::getTranslatorService($container));
        $s = ($container->privates['api_platform.api.identifiers_extractor'] ?? self::getApiPlatform_Api_IdentifiersExtractorService($container));
        ...
        $u = new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($m);
        $v = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($m, $t, $b, $c, $u, NULL, [], $c);
        ...
        return $container->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($b), $e, $e, new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $f), new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($g, [], $f, $container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $f, $container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\GraphQl\Serializer\Exception\ValidationExceptionNormalizer($container->parameters['api_platform.exception_to_status']), new \ApiPlatform\GraphQl\Serializer\Exception\HttpExceptionNormalizer(), new \ApiPlatform\GraphQl\Serializer\Exception\RuntimeExceptionNormalizer(), new \ApiPlatform\GraphQl\Serializer\Exception\ErrorNormalizer(), $e, new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($p, $f), new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($h, $i, $j, $k, $g, $f, $container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($h, $a, $g), new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($g, false, $container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($q, $f), new \ApiPlatform\Problem\Serializer\ErrorNormalizer(false, []), new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), $p, new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(false, $container->parameters['api_platform.serializer.default_context'], $r), new \Symfony\Component\Serializer\Normalizer\UidNormalizer($container->parameters['api_platform.serializer.default_context']), $o, new \ApiPlatform\GraphQl\Serializer\ItemNormalizer($i, $j, $a, $s, $k, $b, $f, $m, NULL, $h, $n), $q, new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer($container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer($container->parameters['api_platform.serializer.default_context'], $t), new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($m, $t, $c, $u, NULL, [])), new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer($container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), new \Symfony\Component\Serializer\Normalizer\TranslatableNormalizer($r, $container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, $container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($l, $k, $a, NULL, $container->parameters['api_platform.serializer.default_context']), 'page', 'pagination', $h, $b, 1, $container->parameters['api_platform.serializer.default_context']), $h, $k, ($container->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], [])), $container->parameters['api_platform.serializer.default_context']), new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($v, $a, $l), new \ApiPlatform\GraphQl\Serializer\ObjectNormalizer($v, $a, $s), $v], [new \Symfony\Component\Serializer\Encoder\XmlEncoder($container->parameters['api_platform.serializer.default_context']), $d, $w, new \Symfony\Component\Serializer\Encoder\CsvEncoder($container->parameters['api_platform.serializer.default_context']), new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $w), new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
